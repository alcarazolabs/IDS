...
def thread():
    ...
    if len(T_connections) != 0:
        ...
        global result
        global alert
        result=[[DP_max[1],SIP_max[1],zerosize/(len(T_connections)*1.0)]]
        res = clf.predict(result)
        if res==1:

            alert=1
            print("!!!!!!!!!!!!!!!!!!!!!!!!!!AAAAAAAAAAALERTTTTTTTTTTTT!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
    ...
    if eth_protocol == 8:
        ...
        if protocol == 6:
            ...
            flow = 'size:' + str(len(data)) + 'SIP:' + str(s_addr) + 'DIP:' + str(d_addr) + 'SP:' + str(
                source_port) + 'DP:' + str(dest_port) + 'protocol:TCP \n'
            f2.write(flow)
            if alert==1:
                alert=0
                f2.write("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!Alert!!!!!!!!!!!!!!!!!!!!!!!!!!")
